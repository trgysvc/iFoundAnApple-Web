...
export async function handleIyzicoPayment(request: Request): Promise<Response> {
  try {
    ...
    const iyzipay = new Iyzipay({
      apiKey:
        process.env.VITE_IYZICO_API_KEY ||
        "sandbox-xQUfDCNqUzFl3TeQ6TwUxk7QovYnthKL",
      secretKey:
        process.env.VITE_IYZICO_SECRET_KEY ||
        "sandbox-njCZVrXuJuKXu12mUdjUs4g9sQHy9PqR",
      uri:
        process.env.VITE_IYZICO_BASE_URL || "https://sandbox-api.iyzipay.com",
    });
