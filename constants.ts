export const translations = {
  ...
  fr: {
    ...
    submit: "Soumettre",
    suggestDescription: "Suggerir une description avec l'IA",
    suggestRewardDescription: "Suggerir une récompense et une description avec l'IA",
    ...
    failedToAddDevice: "Échec de l'ajout du périphérique. Veuillez réessayer.",
    failedToLoadDeviceModels: "Échec du chargement des modèles de périphériques.",
    loadingDeviceModels: "Chargement des modèles de périphériques...",
    ...
    faqContent: {
      ...
      a1: "Notre système associe automatiquement et anonymement un rapport d'appareil perdu d'un propriétaire avec un rapport d'appareil trouvé d'un trouveur basé sur le modèle et le numéro de série de l'appareil. Les deux parties sont notifiées al instant lorsqu'une correspondance est trouvée.",
  ...
  es: {
    ...
    step4Desc: "Sigue nuestras pautas para un intercambio en toute sécurité. Una vez confirmado, el encontrador recibe la recompensa.",
    // Auth Pages
