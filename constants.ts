export const translations = {
  en: {
    ...
    lostDate: "Lost Date",
    lostDateHelper: "Select the date when the device was lost",
    lostLocation: "Lost Location",
    lostLocationHelper: "Please specify in detail where the device was lost",
    foundDate: "Found Date",
    foundDateHelper: "Select the date when the device was found",
    foundLocation: "Found Location",
    foundLocationHelper: "Please specify in detail where the device was found",
    devicePhoto: "Device Photo (Front and Back)",
    devicePhotoHelper: "PNG, JPG, WebP up to 10MB, maximum 2 photos (front and back)",
    maxPhotosError: "Maximum 2 photos can be uploaded (front and back)",
    uploadingFile: "Uploading...",
    fileUploadedSuccess: "File uploaded successfully",
    uploadFile: "Upload a file",
    photoUploadedSuccess: "Photo uploaded successfully",
    savedToSecureStorage: "✓ Saved to secure storage",
    fileFormatsInvoice: "PNG, JPG, WebP, PDF up to 10MB",
  ...
  tr: {
    ...
    lostDate: "Kayıp Tarihi",
    lostDateHelper: "Cihazın kaybolduğu tarihi seçin",
    lostLocation: "Kayıp Yeri",
    lostLocationHelper: "Cihazın kaybolduğu yeri detaylı olarak belirtin",
    foundDate: "Bulunma Tarihi",
    foundDateHelper: "Cihazın bulunduğu tarihi seçin",
    foundLocation: "Bulunma Yeri",
    foundLocationHelper: "Cihazın bulunduğu yeri detaylı olarak belirtin",
    devicePhoto: "Cihaz Fotoğrafı (Ön ve Arka)",
    devicePhotoHelper: "PNG, JPG, WebP up to 10MB, maksimum 2 fotoğraf (ön ve arka)",
    maxPhotosError: "Maksimum 2 fotoğraf yükleyebilirsiniz (ön ve arka)",
    uploadingFile: "Yükleniyor...",
    fileUploadedSuccess: "Dosya başarıyla yüklendi",
    uploadFile: "Dosya yükle",
    photoUploadedSuccess: "Fotoğraf başarıyla yüklendi",
    savedToSecureStorage: "✓ Güvenli depolama alanına kaydedildi",
    fileFormatsInvoice: "PNG, JPG, WebP, PDF up to 10MB",
    backToDeviceList: "Cihazlarım Listesine Geri Dön",
    submit: "Gönder",
  ...
  fr: {
    ...
    lostDateHelper: "Sélectionnez la date à laquelle l'appareil a été perdu",
    lostLocation: "Lieu de perte",
    lostLocationHelper: "Veuillez spécifier en détail où l'appareil a été perdu",
    foundDate: "Date de trouvaille",
    foundDateHelper: "Sélectionnez la date à laquelle l'appareil a été trouvé",
    foundLocation: "Lieu de trouvaille",
    foundLocationHelper: "Veuillez spécifier en détail où l'appareil a été trouvé",
    devicePhoto: "Photo de l'appareil (avant et arrière)",
    devicePhotoHelper: "PNG, JPG, WebP jusqu'à 10MB, maximum 2 photos (avant et arrière)",
    maxPhotosError: "Un maximum de 2 photos peut être téléchargé (avant et arrière)",
    ...
    savedToSecureStorage: "✓ Enregistré dans le stockage sécurisé",
    fileFormatsInvoice: "PNG, JPG, WebP, PDF jusqu'à 10MB",
    backToDeviceList: "Retour à la liste des appareils",
    submit: "Soumettre",
  ...
  ja: {
    ...
    lostDate: "紛失日",
    lostDateHelper: "デバイスを紛失した日を選択してください",
    lostLocation: "紛失場所",
    lostLocationHelper: "デバイスを紛失した場所を詳しく指定してください",
    foundDate: "発見日",
    foundDateHelper: "デバイスを発見した日を選択してください",
    foundLocation: "発見場所",
    foundLocationHelper: "デバイスを発見した場所を詳しく指定してください",
    devicePhoto: "デバイス写真（表と裏）",
    devicePhotoHelper: "PNG、JPG、WebP最大10MB、最大2枚の写真（表と裏）",
    maxPhotosError: "最大2枚の写真をアップロードできます（表と裏）",
    uploadingFile: "アップロード中...",
    fileUploadedSuccess: "ファイルが正常にアップロードされました",
    uploadFile: "ファイルをアップロード",
    photoUploadedSuccess: "写真が正常にアップロードされました",
    savedToSecureStorage: "✓ 安全なストレージに保存されました",
    fileFormatsInvoice: "PNG、JPG、WebP、PDF最大10MB",
    backToDeviceList: "デバイス一覧に戻る",
    submit: "送信",
  ...
  es: {
    ...
    lostDateHelper: "Seleccione la fecha en que se perdió el dispositivo",
    lostLocation: "Ubicación de pérdida",
    lostLocationHelper: "Por favor especifique en detalle dónde se perdió el dispositivo",
    foundDate: "Fecha de hallazgo",
    foundDateHelper: "Seleccione la fecha en que se encontró el dispositivo",
    foundLocation: "Ubicación de hallazgo",
    foundLocationHelper: "Por favor especifique en detalle dónde se encontró el dispositivo",
    devicePhoto: "Foto del dispositivo (frente y reverso)",
    devicePhotoHelper: "PNG, JPG, WebP hasta 10MB, máximo 2 fotos (frente y reverso)",
    maxPhotosError: "Se pueden cargar un máximo de 2 fotos (frente y reverso)",
    ...
    savedToSecureStorage: "✓ Guardado en almacenamiento seguro",
    fileFormatsInvoice: "PNG, JPG, WebP, PDF hasta 10MB",
    backToDeviceList: "Volver a la lista de dispositivos",
    submit: "Enviar",
  ...
  ru: {
    ...
    notifications: {
      ...
      matchFoundFinder: "Найдено совпадение для {model}, о котором вы сообщили. Ожидается оплата владельцем.",
      paymentReceivedFinder: "Получен платеж за {model}! Пожалуйста, приступите к обмену.",
      exchangeConfirmationNeeded: "Другая сторона подтвердила обмен для {model}. Пожалуйста, подтвердите для завершения.",
      transactionCompletedOwner: "Успех! Обмен для вашего {model} завершен.",
    ...
    heroSubtitle: "Мы анонимно связываем вас с человеком, который нашел ваше устройство. Безопасный обмен, справедливое вознаграждение.",
    getStarted: "Начать",
    howItWorks: "Как это работает",
    step1Title: "Владелец сообщает о потере",
    step1Desc: "Если вы потеряли iPhone, iPad или Mac, зарегистрируйте его на нашей платформе с серийным номером.",
    step2Title: "Нашедший сообщает о находке",
    step2Desc: "Любой, кто нашел устройство, может анонимно сообщить о нем, используя серийный номер.",
    step3Title: "Безопасное совпадение и эскроу",
    step3Desc: "Наша система автоматически сопоставляет устройства. Владелец платит вознаграждение в нашу безопасную систему эскроу.",
    ...
    bankInfo: "Информация о банковском счете (для выплаты вознаграждения)",
    agreeToTerms: "Я согласен с {terms} и {privacy}.",
    termsLink: "Условиями обслуживания",
    privacyLink: "Политикой конфиденциальности",
    consentRequired: "Вы должны согласиться с условиями и политикой конфиденциальности для продолжения.",
    ...
    forgotPasswordDesc: "Введите ваш email адрес, и мы отправим вам ссылку для сброса пароля.",
    resetPassword: "Сброс пароля",
    resetPasswordDesc: "Введите ваш новый пароль ниже.",
    resetPasswordError: "Произошла ошибка. Пожалуйста, попробуйте снова.",
    emailSent: "Email отправлен!",
    resetPasswordEmailSent: "Мы отправили ссылку для сброса пароля на ваш email. Пожалуйста, проверьте почту.",
    sendResetLink: "Отправить ссылку для сброса",
    sending: "Отправка...",
    rememberPassword: "Вспомнили пароль?",
    backToLogin: "Вернуться к входу",
    passwordResetSuccess: "Пароль успешно сброшен!",
    passwordResetSuccessDesc: "Ваш пароль успешно сброшен. Теперь вы можете войти с новым паролем.",
    invalidResetLink: "Недействительная или истекшая ссылка для сброса. Пожалуйста, запросите новую.",
    ...
    noDevicesReported: "Вы еще не сообщили о каких-либо устройствах.",
    // Device Forms
    deviceModelForm: "Модель устройства (например, iPhone 15 Pro)",
    deviceSerialNumber: "Серийный номер",
    deviceColor: "Цвет",
    deviceDescription: "Дополнительные детали (необязательно)",
    deviceInvoice: "Подтверждение покупки (Счет)",
    deviceInvoiceHelper: "Необязательно. Помогает подтвердить владение.",
    lostDate: "Дата потери",
    lostDateHelper: "Выберите дату, когда устройство было потеряно",
    lostLocation: "Место потери",
    lostLocationHelper: "Пожалуйста, укажите подробно, где было потеряно устройство",
    foundDate: "Дата находки",
    foundDateHelper: "Выберите дату, когда устройство было найдено",
    foundLocation: "Место находки",
    foundLocationHelper: "Пожалуйста, укажите подробно, где было найдено устройство",
    devicePhoto: "Фото устройства (спереди и сзади)",
    devicePhotoHelper: "PNG, JPG, WebP до 10MB, максимум 2 фото (спереди и сзади)",
    maxPhotosError: "Можно загрузить максимум 2 фото (спереди и сзади)",
    uploadingFile: "Загрузка...",
    fileUploadedSuccess: "Файл успешно загружен",
    uploadFile: "Загрузить файл",
    photoUploadedSuccess: "Фото успешно загружено",
    savedToSecureStorage: "✓ Сохранено в безопасное хранилище",
    fileFormatsInvoice: "PNG, JPG, WebP, PDF до 10MB",
    backToDeviceList: "Вернуться к списку устройств",
    submit: "Отправить",
    suggestDescription: "Предложить описание с ИИ",
    suggestRewardDescription: "Предложить вознаграждение и описание с ИИ",
    gettingSuggestions: "Получение предложений...",
    aiSuggestion: "Предложение ИИ",
    suggestedReward: "Предлагаемое вознаграждение",
    basedOnValue: "На основе оценочной стоимости {value}",
    aiError: "Не удалось получить предложения ИИ. Пожалуйста, заполните детали вручную.",
    failedToAddDevice: "Не удалось добавить устройство. Пожалуйста, попробуйте снова.",
    ...
    termsAgreement: "Я прочитал и согласен с Условиями обслуживания и Политикой конфиденциальности. Я понимаю, что мой платеж будет храниться в безопасной системе эскроу и будет переведен нашедшему после доставки устройства.",
    securePayment: "Выполнить безопасный платеж",
    paymentProcessing: "Обработка платежа...",
    paymentSecurityNotice: "🔒 Этот платеж защищен SSL. Информация о вашей карте безопасно зашифрована и не хранится.",
    deviceModelNotSpecified: "Модель устройства не указана",
    feeCalculationFailed: "Не удалось выполнить расчет комиссии",
    feeCalculationError: "Произошла ошибка при расчете комиссии",
    paymentLoginRequired: "Вы должны войти в систему для совершения платежа",
    missingPaymentInfo: "Отсутствует информация о платеже",
    acceptTermsRequired: "Пожалуйста, примите условия обслуживания",
    paymentInitiated: "Платеж успешно инициирован!",
    paymentFailed: "Платеж не выполнен",
    paymentError: "Произошла ошибка при обработке платежа",
    calculatingFees: "Расчет комиссии...",
    errorOccurred: "Произошла ошибка",
    // Cargo related
    cargoTracking: "Отслеживание груза",
    refresh: "Обновить",
    detailedTracking: "Детальное отслеживание",
    ...
    cargoSupport: "Поддержка груза: По вопросам, связанным с грузом, вы можете позвонить в службу поддержки грузовой компании или связаться с нами, используя ваш анонимный ID код.",
    cargoLoadingInfo: "Загрузка информации о грузе...",
    cargoTrackingNotFound: "Информация об отслеживании груза не найдена",
    trackingInfoLoadError: "Произошла ошибка при загрузке информации об отслеживании",
    tryAgain: "Попробовать снова",
    noCargoMovement: "Пока нет движения груза",
    // Payment Flow & Match Payment translations
    matchPayment: "Платеж при совпадении",
    matchPaymentSubtitle: "Получите свое устройство обратно безопасно",
    deviceRecoveryPayment: "Платеж за восстановление устройства",
    deviceRecoverySubtitle: "Получите свое потерянное устройство обратно безопасно",
    feeDetails: "Детали комиссии",
    payment: "Платеж",
    deviceModel: "Модель устройства",
    stepIndicatorModel: "Модель устройства",
    stepIndicatorFees: "Детали комиссии",
    stepIndicatorPayment: "Платеж",
    ...
    customRewardAmount: "Индивидуальная сумма вознаграждения",
    customRewardDescription: "Необязательно: Если вы хотите дать большее вознаграждение нашедшему, вы можете установить это здесь.",
    defaultReward: "По умолчанию: {amount} TL",
    customRewardSet: "✓ Индивидуальная сумма вознаграждения: {amount} TL",
    changeDeviceModel: "← Изменить модель устройства",
    backToFeeDetails: "← Назад к деталям комиссии",
    finderRewardLabel: "Вознаграждение нашедшему:",
    cargoLabel: "Груз:",
    serviceFeeLabel: "Комиссия сервиса:",
    gatewayFeeLabel: "Комиссия платежа:",
    totalLabel: "ИТОГО:",
    ...
    ifoundanappleFeeBreakdown: "Распределение комиссий iFoundAnApple",
    finderRewardDesc: "К выплате нашедшему",
    cargoFeeDesc: "Для безопасной доставки",
    serviceFeeDesc: "Комиссия платформы",
    paymentCommissionDesc: "Для безопасного платежа",
    totalPayment: "Общий платеж",
    paymentDue: "Сумма к оплате сейчас",
    finderNetPayment: "Чистый платеж нашедшему",
    afterServiceFeeDeduction: "После вычета комиссии сервиса",
    securePaymentSystem: "Безопасная система эскроу",
    escrowSystemDesc: "Ваш платеж хранится в нашем безопасном эскроу-счете и не будет переведен до тех пор, пока устройство не будет доставлено и подтверждено. С гарантией Iyzico у вас есть право на отмену и возврат за исключением комиссии 3.43%.",
    // Payment Method Selector translations
    paymentMethod: "Способ оплаты",
    securePaymentOptions: "Безопасные способы оплаты",
    recommended: "РЕКОМЕНДУЕТСЯ",
    instant: "Мгновенно",
    free: "Бесплатно",
    turkeyTrustedPayment: "Надежная платежная система Турции",
    internationalSecurePayment: "Международный безопасный платеж",
    developmentTestPayment: "Тестовый платеж для разработки",
    turkeyMostTrustedPayment: "Самая надежная платежная система Турции",
    worldStandardSecurity: "Безопасность мирового стандарта",
    developmentTestMode: "Тестовый режим разработки",
    iyzico3DSecure: "Защищено 3D Secure, сертифицированный безопасный платеж PCI DSS. Поддерживаются все турецкие банки.",
    stripeInternational: "Безопасность международного стандарта, защищено 256-битным SSL-шифрованием.",
    testModeDesc: "Без реального перевода денег. Только для целей разработки и тестирования.",
    ...
    Matched: "Совпадение! Ожидается оплата владельцем.",
    PaymentPending: "Совпадение! Пожалуйста, продолжите оплату.",
    PaymentComplete: "Оплата завершена! Приступите к обмену.",
    ExchangePending: "Ожидается обмен",
    Completed: "Завершено",
    // Device Detail Page
    deviceDetails: "Детали устройства",
    matchFoundDevice: "Найдено совпадение для вашего устройства!",
    reward: "Вознаграждение",
    makePaymentSecurely: "Выполнить безопасный платеж",
    waitingForOwnerPayment: "Ожидание оплаты от владельца.",
    matchFoundTitle: "Совпадение найдено!",
    paymentReceived: "Платеж получен!",
    paymentSecureExchange: "Ваш платеж безопасно хранится. Пожалуйста, следуйте инструкциям для завершения обмена и подтверждения.",
    finderPaymentSecureExchange: "Платеж безопасно хранится. Пожалуйста, следуйте инструкциям для завершения обмена и подтверждения.",
    confirmExchange: "Я подтверждаю обмен",
    waitingForOtherParty: "Ожидание подтверждения другой стороной...",
    secureExchangeGuidelines: "Рекомендации по безопасному обмену",
    guideline1: "Договоритесь о встрече в безопасном общественном месте, таком как полицейский участок или хорошо освещенное кафе.",
    guideline2: "Альтернативно, используйте отслеживаемую и застрахованную службу доставки для обмена устройством.",
    guideline3: "Не делитесь личной контактной информацией. При необходимости общайтесь только через нашу платформу.",
    guideline4: "После успешного обмена устройством нажмите кнопку подтверждения ниже.",
    transactionCompleted: "Транзакция завершена!",
    transactionCompletedDesc: "Вознаграждение переведено нашедшему. Спасибо за использование iFoundAnApple.",
    serviceFeeNotice: "С вознаграждения вычтена комиссия сервиса 5% для покрытия операционных расходов.",
    backToDashboard: "Вернуться на панель",
    goBack: "Назад",
    loading: "Загрузка...",
    loadingPageContent: "Пожалуйста, подождите, пока страница загружается...",
    ...
    contactIntro: "Если у вас есть вопросы или вам нужна поддержка, пожалуйста, свяжитесь с нами. Мы здесь, чтобы помочь!",
    contactEmail: "info@ifoundanapple.com",
    faqIntro: "Найдите ответы на распространенные вопросы о нашей платформе.",
    faqContent: {
      q1: "Как работает процесс совпадения?",
      a1: "Наша система автоматически и анонимно сопоставляет отчет о потерянном устройстве от владельца с отчетом о найденном устройстве от нашедшего на основе модели устройства и серийного номера. Обе стороны уведомляются немедленно, когда найдено совпадение.",
      q2: "Безопасна ли моя личная информация?",
